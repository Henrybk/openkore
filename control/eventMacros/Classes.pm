...
macro set_class_stats_and_skills {
	...
	if ($configClass = rogue) {
		...
		do conf -f statsAddAuto_list 15 agi, 15 dex, 15 str, 20 agi, 10 vit, 25 agi, 25 dex, 30 agi, 30 dex, 20 str, 15 vit, 50 agi, 20 vit, 15 luk, 35 dex, 35 str, 35 vit, 70 agi, 50 str, 50 dex, 45 vit, 75 agi, 55 str, 50 vit, 80 agi, 65 str, 60 vit, 70 str, 90 agi
        do conf -f skillsAddAuto_list NV_BASIC 9, SM_SWORD 1, SM_RECOVERY 10, SM_TWOHAND 10, SM_PROVOKE 5, SM_ENDURE 10, SM_BASH 10, SM_BASH 10, SM_MAGNUM 3, KN_TWOHANDQUICKEN 10, KN_RIDING 1, KN_CAVALIERMASTERY 5, KN_AUTOCOUNTER 5, KN_BOWLINGBASH 10
	}
}
