...
#line 1 "src\\\\auto\\\\XSTools\\\\DrunkPath\\\\PathFinding.xs"
#include <stdlib.h>
#include <time.h>
#include "EXTERN.h"
#include "perl.h"
...
#line 20 "src\\auto\\XSTools\\DrunkPath\\PathFinding.c"
...
#line 164 "src\\auto\\XSTools\\DrunkPath\\PathFinding.c"
...
XS_EUPXS(XS_DrunkPath_create)
{
    ...
    {
	DrunkPath	RETVAL;
#line 16 "src\\\\auto\\\\XSTools\\\\DrunkPath\\\\PathFinding.xs"
		RETVAL = CalcDrunkPath_new ();

#line 177 "src\\auto\\XSTools\\DrunkPath\\PathFinding.c"
	{
	    SV * RETVALSV;
...
;
	SV *	drunkness = ST(14)
;
#line 41 "src\\\\auto\\\\XSTools\\\\DrunkPath\\\\PathFinding.xs"
		char *weight_map_data = NULL;

#line 229 "src\\auto\\XSTools\\DrunkPath\\PathFinding.c"
...
;
#line 45 "src\\\\auto\\\\XSTools\\\\DrunkPath\\\\PathFinding.xs"
...
#line 394 "src\\auto\\XSTools\\DrunkPath\\PathFinding.c"
    }
    XSRETURN_EMPTY;
}
...
;
#line 206 "src\\\\auto\\\\XSTools\\\\DrunkPath\\\\PathFinding.xs"
		int status;
#line 412 "src\\auto\\XSTools\\DrunkPath\\PathFinding.c"
	int	RETVAL;
	dXSTARG;
	...
	session = (DrunkPath) tmp;
		...
		croak("session is not of type DrunkPath")
;
#line 209 "src\\\\auto\\\\XSTools\\\\DrunkPath\\\\PathFinding.xs"
		/* Check for any missing arguments */
...
#line 480 "src\\auto\\XSTools\\DrunkPath\\PathFinding.c"
...
XS_EUPXS(XS_DrunkPath_runcount)
{
    ...
    {
	DrunkPath	session;
#line 272 "src\\\\auto\\\\XSTools\\\\DrunkPath\\\\PathFinding.xs"
		int status;
#line 497 "src\\auto\\XSTools\\DrunkPath\\PathFinding.c"
	int	RETVAL;
	dXSTARG;
	...
	session = (DrunkPath) tmp;
		...
		croak("session is not of type DrunkPath")
;
#line 275 "src\\\\auto\\\\XSTools\\\\DrunkPath\\\\PathFinding.xs"
		status = CalcDrunkPath_pathStep (session);
...
#line 516 "src\\auto\\XSTools\\DrunkPath\\PathFinding.c"
	XSprePUSH; PUSHi((IV)RETVAL);
    }
    XSRETURN(1);
}
...
XS_EUPXS(XS_DrunkPath_DESTROY)
{
    ...
    {
	DrunkPath	session;
#line 289 "src\\\\auto\\\\XSTools\\\\DrunkPath\\\\PathFinding.xs"
		session = (DrunkPath) 0; /* shut up compiler warning */
#line 533 "src\\auto\\XSTools\\DrunkPath\\PathFinding.c"
	...
	session = (DrunkPath) tmp;
		...
		croak("session is not of type DrunkPath")
;
#line 291 "src\\\\auto\\\\XSTools\\\\DrunkPath\\\\PathFinding.xs"
		CalcDrunkPath_destroy (session);
#line 544 "src\\auto\\XSTools\\DrunkPath\\PathFinding.c"
    }
    XSRETURN_EMPTY;
}
